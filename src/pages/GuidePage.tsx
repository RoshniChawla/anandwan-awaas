      ...
      <section className="relative py-12 bg-muted">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">What a Guest Can Do</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            <div className="bg-card p-8 rounded-xl shadow-lg border border-border">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-foreground">Register to Stay</h2>
              </div>
            ...
            <div className="bg-card p-8 rounded-xl shadow-lg border border-border">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-foreground">Explore the Environment</h2>
              </div>
              <p className="text-muted-foreground mb-6">
            ...
            <div className="bg-card p-8 rounded-xl shadow-lg border border-border">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-foreground">Volunteer</h2>
              </div>
              <p className="text-muted-foreground mb-6">
            ...
            <div className="bg-card p-8 rounded-xl shadow-lg border border-border">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h2 className="text-2xl font-bold text-foreground">Donate</h2>
              </div>
              <p className="text-muted-foreground mb-6">
