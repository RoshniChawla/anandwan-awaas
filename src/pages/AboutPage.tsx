      ...
      <section className="relative py-20 bg-muted">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-foreground">About Anandwan Awaas</h1>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-foreground">Anandwan Awaas: A Sanctuary of Healing and Service</h2>
            <div className="w-20 h-1 bg-primary-500 mx-auto mb-6"></div>
          </div>

          <div className="max-w-4xl mx-auto space-y-8 text-muted-foreground text-lg leading-relaxed">
            <p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-card p-6 rounded-lg border border-border">
              ...
              <h3 className="text-xl font-bold mb-2 text-foreground">Compassion</h3>
              <p className="text-muted-foreground">
